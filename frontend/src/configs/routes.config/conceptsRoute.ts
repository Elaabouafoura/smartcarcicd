...
const conceptsRoute: Routes = [
    ...
    },
    {
        ...
        component: lazy(() => import('@/views/concepts/VehicleAnomaly')) as unknown as any,
        authority: [ADMIN, USER, MECHANIC],
        meta: {
            pageContainerType: 'contained',
...
},
   {
    ...
    },
    {
       ...
       {
        key: 'concepts.products.vehiclrecommendation',
        path: `${CONCEPTS_PREFIX_PATH}/vehicles/recommendation/:id`,
        component: lazy(() => import('@/views/concepts/vehicles/VehicleRecommendations')),
        authority: [ ADMIN,USER],
        meta: {
            pageContainerType: 'contained',
        },
